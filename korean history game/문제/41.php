...
<body>
<img src="초시계.gif">
1880년대에 이만손과 영남 유생들은 조선책략 유포를 반대하면서 영남 만인소를 올렸다.<br>
...
<form method="post" action="게임오버.php">
  ...
  <input type="image" src="X.png" width="50%" align="right" onclick="window.alert('1880년대에 이만손과 영남 유생들은 조선책략 유포를 반대하면서 영남 만인소를 올렸다.')">
</form>
</form>
</body>
</html>
