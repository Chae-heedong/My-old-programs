...
<body>
<img src="초시계.gif">
임오군란 이후 조선은 제물포 조약을 체결해 일본에게 배상금을 지급하고 일본군 주둔을 허락하였다.<br>
...
<form method="post" action="게임오버.php">
  ...
  <input type="image" src="X.png" width="50%" align="right" onclick="window.alert('임오군란 이후 조선은 제물포 조약을 체결해 일본에게 배상금을 지급하고 일본군 주둔을 허락하였다.')">
</form>
</form>
</body>
</html>
