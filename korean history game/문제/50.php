...
<body>
<img src="초시계.gif">
임오군란 이후 조선은 제물포 조약을 체결해 청나라에게 배상금을 지급하고 청군 주둔을 허락하였다.<br>
<form method="post" action="게임오버.php">
  <input type="hidden" value="<?php echo$_POST['점수'];?>" name="점수">
  <input type="image" src="O.png" width="50%" align="left" onclick="window.alert('임오군란 이후 조선은 제물포 조약을 체결해 일본에게 배상금을 지급하고 일본군 주둔을 허락하였다.')">
</form>
