...
<body>
<img src="초시계.gif">
흥선대원군이 물러나고 고종이 직접 정치를 하면서 통상 수교 거부 정책이 완화되었다.<br>
...
<form method="post" action="게임오버.php">
  ...
  <input type="image" src="X.png" width="50%" align="right" onclick="window.alert('흥선대원군이 물러나고 고종이 직접 정치를 하면서 통상 수교 거부 정책이 완화되었다.')">
</form>
</form>
</body>
</html>
