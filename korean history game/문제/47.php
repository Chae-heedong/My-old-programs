...
<body>
<img src="초시계.gif">
임오군란 이후 조선은 조청상민수륙무역장정을 체결해 청나라 상인의 내지무역을 허용했다.<br>
...
<form method="post" action="게임오버.php">
  ...
  <input type="image" src="X.png" width="50%" align="right" onclick="window.alert('임오군란 이후 조선은 조청상민수륙무역장정을 체결해 청나라 상인의 내지무역을 허용했다.')">
</form>
</form>
</body>
</html>
